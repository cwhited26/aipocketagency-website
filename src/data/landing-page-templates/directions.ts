...
export const DIRECTIONS: readonly Direction[] = [
  ...
  // ── Motionsites-tier canvas animations — 2026-06-14 batch ──────────────────
  {
    "slug": "weblex-dark-hero",
    "name": "Weblex — Dark Hero",
    "vibe": ["dark", "web3", "bold", "futuristic"],
    "industries": ["crypto", "fintech", "web3", "infrastructure", "SaaS"],
    "useCases": ["hero"],
    "tierRequired": "starter",
    "visualPreview": { "static": null, "animated": null },
    "typography": { "display": "Space Mono", "body": "Inter" },
    "colorPalette": ["#030408", "#0D1B2A", "#4A9FFF", "#E8EDF2"],
    "motifs": ["3D flying rock particles with depth", "scan line overlay", "perspective projection", "stats bar"],
    "whenToUse": ["Web3 protocols", "blockchain infrastructure", "dark tech heroes needing depth and motion"],
    "whenNotToUse": ["light brands", "consumer apps", "e-commerce"],
    "buildComplexity": "high",
    "source": "Chase-original motionsites-tier canvas component (2026-06-14)",
    "featured": true,
    "newUntil": "2026-09-14",
    "animatedReact": true,
    "promptText": "Dark Web3 hero with irregular rock/debris particles flying toward the viewport in perspective projection. Canvas rAF animation — N=70 rocks with polygon vertices, lit face gradients, edge highlights, depth alpha fade. Blue (#4A9FFF) accent on deep navy (#030408). UI: WEBLEX brand top-left, nav links, Launch App CTA, hero headline 'Build On Nothing But Truth.', stats bar with TVL/uptime/wallets/finality, scan line overlay, mainnet live indicator."
  },
  {
    "slug": "nova-space-systems",
    "name": "NOVA — Space Systems",
    "vibe": ["dark", "futuristic", "cinematic", "bold"],
    "industries": ["aerospace", "space tech", "defense", "science", "research"],
    "useCases": ["hero"],
    "tierRequired": "starter",
    "visualPreview": { "static": null, "animated": null },
    "typography": { "display": "Inter", "body": "Inter" },
    "colorPalette": ["#020409", "#0A1628", "#1E3A5F", "#C8A96E", "#F5F0E8"],
    "motifs": ["orbiting planets", "twinkling star field", "sun corona pulse", "orbital rings"],
    "whenToUse": ["space tech", "aerospace brands", "science organizations", "deep-tech startups"],
    "whenNotToUse": ["consumer brands", "food/beverage", "healthcare"],
    "buildComplexity": "high",
    "source": "Chase-original motionsites-tier canvas component (2026-06-14)",
    "featured": true,
    "newUntil": "2026-09-14",
    "animatedReact": true,
    "promptText": "Full solar system animation on canvas. 380 stars with twinkle effect, sun with animated corona/glow rings, 3 planets (moon, ringed Saturn-like, small) with orbital paths. NOVA brand 3-column nav, 140px 'ROCKETS' hero headline, launch CTA, bottom info strip."
  },
  {
    "slug": "slam-dunk",
    "name": "Slam Dunk",
    "vibe": ["bold", "energetic", "dark", "sports"],
    "industries": ["sports", "fitness", "basketball", "athletic wear", "events"],
    "useCases": ["hero"],
    "tierRequired": "starter",
    "visualPreview": { "static": null, "animated": null },
    "typography": { "display": "Inter", "body": "Inter" },
    "colorPalette": ["#0A0A0A", "#F5A623", "#E8E0D0", "#1A1A1A"],
    "motifs": ["player silhouette dunking", "ball arc trajectory", "rim impact flash", "crowd haze"],
    "whenToUse": ["basketball brands", "sports events", "athletic apparel", "fitness apps with sports focus"],
    "whenNotToUse": ["professional services", "healthcare", "luxury goods"],
    "buildComplexity": "high",
    "source": "Chase-original motionsites-tier canvas component (2026-06-14)",
    "featured": true,
    "newUntil": "2026-09-14",
    "animatedReact": true,
    "promptText": "Cinematic basketball dunk animation on canvas. Player silhouette with approach/jump/hang/dunk phases, ball following cubic bezier arc to rim, rim impact flash + shockwave, crowd haze in background. Gold accent (#F5A623) on near-black. Sports brand UI with 'SLAM DUNK' headline."
  },
  {
    "slug": "framelix-3d-studios",
    "name": "Framelix — 3D Studios",
    "vibe": ["dark", "cinematic", "luxury", "creative"],
    "industries": ["film", "video production", "creative agency", "photography", "animation"],
    "useCases": ["hero"],
    "tierRequired": "starter",
    "visualPreview": { "static": null, "animated": null },
    "typography": { "display": "Inter", "body": "Courier New" },
    "colorPalette": ["#0C0C0C", "#F5F2ED", "#C8A96E", "#8B6F3E"],
    "motifs": ["CSS 3D film frame rotation", "camera dolly motion", "depth-of-field side frames", "timecode overlay"],
    "whenToUse": ["film studios", "video production companies", "creative agencies with cinematic work", "3D/VFX studios"],
    "whenNotToUse": ["consumer brands", "e-commerce", "SaaS"],
    "buildComplexity": "high",
    "source": "Chase-original motionsites-tier CSS 3D component (2026-06-14)",
    "featured": true,
    "newUntil": "2026-09-14",
    "animatedReact": true,
    "promptText": "Cinematic film studio hero with CSS 3D perspective. Main frame rotates on Y/X axes, camera dolly translateZ animation, blurred depth-of-field side frames. 5 scenes cycle with slide-in/out transitions. Timecode + scene number overlay, FRAMELIX brand, 'We Create Cinema.' headline, gold (#C8A96E) accent, filmstrip progress bar."
  },
  {
    "slug": "neo-museum",
    "name": "Neo Museum",
    "vibe": ["editorial", "minimal", "refined", "cultural"],
    "industries": ["museum", "gallery", "arts", "cultural institution", "luxury"],
    "useCases": ["hero"],
    "tierRequired": "starter",
    "visualPreview": { "static": null, "animated": null },
    "typography": { "display": "Inter", "body": "Inter" },
    "colorPalette": ["#F8F5EE", "#111111", "#2A2A2A", "#8B7355"],
    "motifs": ["masked mega-type reveal", "gallery card slide", "chapter counter", "ticker tape", "progress bar"],
    "whenToUse": ["museums", "art galleries", "cultural institutions", "luxury editorial brands"],
    "whenNotToUse": ["dark-themed brands", "tech startups", "e-commerce"],
    "buildComplexity": "high",
    "source": "Chase-original motionsites-tier CSS animation component (2026-06-14)",
    "featured": true,
    "newUntil": "2026-09-14",
    "animatedReact": true,
    "promptText": "High-design museum hero with kinetic typography. Giant masked text reveals behind sliding exhibit gallery cards. Cream (#F8F5EE) background with deep (#111111) type. 5 exhibit chapters auto-cycle with enter/exit card animations. Left panel: chapter counter, exhibit name with skew-reveal animation, sub-label, description, 'Explore Exhibition' CTA, progress bar. Right: stacked gallery cards with 3D depth. Bottom ticker tape with chapter names."
  },
  {
    "slug": "new-era-automotive",
    "name": "New Era Automotive",
    "vibe": ["dark", "luxury", "cinematic", "bold"],
    "industries": ["automotive", "luxury", "EV", "performance cars", "transportation"],
    "useCases": ["hero"],
    "tierRequired": "starter",
    "visualPreview": { "static": null, "animated": null },
    "typography": { "display": "Inter", "body": "Inter" },
    "colorPalette": ["#050508", "#0A0A14", "#4A9FFF", "#C0D8FF", "#2A4A7A"],
    "motifs": ["car silhouette reveal", "headlight sweep", "chrome trim highlight", "wheel spoke lighting", "spec bar"],
    "whenToUse": ["automotive brands", "EV companies", "performance car launches", "luxury vehicle dealers"],
    "whenNotToUse": ["non-automotive brands", "consumer goods", "healthcare"],
    "buildComplexity": "high",
    "source": "Chase-original motionsites-tier canvas component (2026-06-14)",
    "featured": true,
    "newUntil": "2026-09-14",
    "animatedReact": true,
    "promptText": "Automotive hero with car silhouette built from Path2D bezier curves. 5200ms sweep animation — light crosses left to right revealing car body progressively. Dual headlight cones with blue-white radial glow, chrome roofline trim keyed to sweep position, wheel spokes with lighting, red tail light. Brand top-left, 2026 model badge, bottom spec bar with range/power/0-60/top speed."
  },
  {
    "slug": "equilibrium",
    "name": "Equilibrium",
    "vibe": ["dark", "scientific", "minimal", "futuristic"],
    "industries": ["finance", "science", "research", "physics", "EdTech"],
    "useCases": ["hero"],
    "tierRequired": "starter",
    "visualPreview": { "static": null, "animated": null },
    "typography": { "display": "Inter", "body": "Inter" },
    "colorPalette": ["#0A0A16", "#E8C97E", "#8EC5FC", "#C8A0F0", "#F0EEE9"],
    "motifs": ["pendulum physics RK4", "glowing bob trails", "balance beam", "coupled oscillators"],
    "whenToUse": ["physics/science brands", "fintech with balance/equilibrium messaging", "research institutions", "EdTech"],
    "whenNotToUse": ["consumer brands", "food/beverage", "retail"],
    "buildComplexity": "high",
    "source": "Chase-original motionsites-tier canvas component (2026-06-14)",
    "featured": true,
    "newUntil": "2026-09-14",
    "animatedReact": true,
    "promptText": "Triple pendulum physics simulation with Runge-Kutta 4 integration. Two coupled systems sharing a balance beam. Each system has 3 bobs with colored trails, glowing sphere gradients, rod highlights. Deep indigo (#0A0A16) background with gold/blue/purple bobs. 'Perfect Balance.' headline, physics lab nav, RK4/damping/rate data bar at bottom."
  },
  {
    "slug": "automation-machines",
    "name": "Automation Machines",
    "vibe": ["dark", "industrial", "bold", "technical"],
    "industries": ["manufacturing", "robotics", "industrial", "automation", "engineering"],
    "useCases": ["hero"],
    "tierRequired": "starter",
    "visualPreview": { "static": null, "animated": null },
    "typography": { "display": "Inter", "body": "Inter" },
    "colorPalette": ["#0A0F1A", "#1E2D40", "#F0A500", "#3A8EBA"],
    "motifs": ["interlocking gears", "robotic arm assembly", "gripper animation", "assembly tray"],
    "whenToUse": ["manufacturing companies", "robotics brands", "industrial automation", "engineering firms"],
    "whenNotToUse": ["consumer brands", "lifestyle", "healthcare"],
    "buildComplexity": "high",
    "source": "Chase-original motionsites-tier canvas component (2026-06-14)",
    "featured": true,
    "newUntil": "2026-09-14",
    "animatedReact": true,
    "promptText": "Industrial automation hero with interlocking gear system and robotic arm. 6 gears with realistic tooth geometry, spoke detail, hub highlights, amber/steel-blue palette. 3-joint robotic arm with sinusoidal movement, joint ball highlights, gripper opening/closing animation. Assembly tray with items toggling assembled state. 'Built By Machines.' headline, industrial nav, throughput/DOF/tolerance/uptime data bar."
  }
];
