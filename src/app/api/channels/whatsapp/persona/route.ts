// POST /api/channels/whatsapp/persona — set the Persona that answers on the owner's WhatsApp
...
export async function POST(request: NextRequest): Promise<NextResponse> {
  ...
  const res = await setChannelConnectionPersona(user.id, "whatsapp", personaId);
