...
export default function LeadMagnetForm() {
  ...
  if (phase === "done") {
    return (
      <div className="mt-5 rounded-xl border border-accent/30 bg-accent/[0.06] px-5 py-4 text-sm leading-relaxed text-slate-200">
        Got it — your guide is on its way. Watch your inbox over the next few days.
      </div>
    );
  }
